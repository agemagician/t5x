...
def temperature_sample(
  ...
  Args:
    ...
    state_callback_fn: Optional[Callable[[SamplingLoopState],
      SamplingLoopState]]: Function that modifies the sampling loop state before
    ...
    logit_callback_fn: Optional[Callable[[array, SamplingLoopState], array]]:
      Function that modifies the logits before each temperature sampling step.
      The function should take arguments (logits, state) and it should return
      the modified logits.
